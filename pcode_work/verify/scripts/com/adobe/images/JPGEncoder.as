      ...
      public function encode(image:BitmapData) : ByteArray
      {
         ...
         for(var ypos:int = 0; ypos < image.height; ypos += 8)
         {
            for(xpos = 0; xpos < image.width; xpos += 8)
            {
               ...
               DCY = Number(this.processDU(this.YDU,this.fdtbl_Y,DCY,this.YDC_HT,this.YAC_HT));
               DCU = Number(this.processDU(this.UDU,this.fdtbl_UV,DCU,this.UVDC_HT,this.UVAC_HT));
               DCV = Number(this.processDU(this.VDU,this.fdtbl_UV,DCV,this.UVDC_HT,this.UVAC_HT));
            }
         }
         if(this.bytepos >= 0)
         {
